...
df = pd.read_csv("C:\\Users\\priya.cse2009\\Documents\\Python Scripts\\yelp\\BIA_660_Finalproject\\model_data.csv")

#Create demo sample data set
sample_size = 10000
...
negative_indices = df[ df['stars_category']==0].index
random_indices = np.random.choice(negative_indices,sample_size,replace=False)
negative_sample = df.loc[random_indices]
...
counter = CountVectorizer(min_df=500)
